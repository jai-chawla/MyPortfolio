...
const Home = () => {
  return (
    <div name="home" className=' h-screen w-full  bg-gradient-to-b from-black via-black to-gray-800'>
      <div className='max-w-screen-lg mx-auto flex flex-col items-center justify-center h-full px-4 md:flex-row md:space-x-6'>
        <div className='flex flex-col justify-center h-full'>
          <h2 className='mt-16 text-4xl sm:text-5xl sm:mt-20  font-bold text-white'>
